...
<html lang="en">
    <head>
       ...
       <link rel="shortcut icon" href="{{ asset('assets/img/favicon.ico') }}" type="image/x-icon">
		...
		<!-- Web Fonts  -->
		<link id="googleFonts" href="../../../css?family=Poppins:300,400,500,600,700,800&display=swap" rel="stylesheet" type="text/css">
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{ asset('assets/css/demos/demo-auto-services.css') }}">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="{{ asset('assets/css/skins/skin-auto-services.css') }}">
    ...
    <body>
		...
		<!-- Demo -->
		<script src="{{ asset('assets/js/demos/demo-auto-services.js') }}"></script>
