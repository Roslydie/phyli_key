    ...
    <div class="container-fluid position-relative z-2 py-5">
        ...
        <div class="text-center text-white mx-auto hero-content">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 mb-5">
                <a href="tel:+17735217000" class="btn btn-warning btn-lg px-5 py-3">
                    📞 Call Now: (773) 521-7000
                </a>

                <a href="#quote" class="btn btn-light btn-lg px-5 py-3">
                    Get Free Quote
                </a>
            </div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center">
							...
							<div class="col-lg-5 text-center text-lg-start ps-lg-4">
								<a href="demo-auto-services-appointment.html" class="btn btn-primary btn-outline custom-btn-border-radius font-weight-bold text-3 btn-px-5 btn-py-3 ms-lg-2 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="1500">MAKE AN APPOINTMENT</a>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="row align-items-center justify-content-center pb-4 mb-5">
						<div class="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
							...
							<div class="d-flex align-items-start align-items-sm-center flex-column flex-sm-row">
								<a href="demo-auto-services-about-us.html" class="btn btn-primary text-color-light custom-btn-border-radius font-weight-bold text-3 px-5 btn-py-3 me-sm-2 mb-3 mb-sm-0 appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="950">VIEW MORE</a>
				...
				<div class="container py-5 my-5">
					...
					<div class="row">
						<div class="col text-center">
							<a href="demo-auto-services-services.html" class="btn btn-primary text-color-light custom-btn-border-radius font-weight-bold text-3 btn-px-5 btn-py-3 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="850">VIEW ALL SERVICES</a>
						</div>
					</div>
				</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-xl-5">
								<div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
									...
									<a href="demo-auto-services-appointment.html" class="btn btn-light btn-outline custom-btn-border-radius border-color-light font-weight-bold text-color-light text-color-hover-dark bg-color-hover-light btn-px-5 btn-py-3">MAKE AN APPOINTMENT</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row row-gutter-sm">
						...
						<div class="col-md-4 col-lg-3 text-center text-md-start">
							<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
								...
								<a href="demo-auto-services-about-us.html" class="btn btn-primary text-color-light custom-btn-border-radius font-weight-bold btn-px-5 py-3 mb-2">VIEW MORE</a>
							...
							<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100">
								...
								<a href="demo-auto-services-contact.html" class="btn btn-primary text-color-light custom-btn-border-radius font-weight-bold btn-px-5 py-3">CONTACT US</a>
							</div>
						</div>
					</div>
				</div>
