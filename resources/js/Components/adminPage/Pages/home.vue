          ...
          <div class="card">
            ...
            <div class="card-body p-4">
              <div class="chart-card">
                <svg viewBox="0 0 320 180" class="w-100" role="img" aria-label="Sales vs purchase chart">
                  <rect x="0" y="0" width="320" height="180" rx="12" fill="#fff" />
                  ...
                  <path d="M30 125 L80 105 L130 95 L180 85 L230 70 L270 55 L300 40" fill="none" stroke="#f59e0b" stroke-width="4" stroke-linecap="round" />
                  <path d="M30 140 L80 120 L130 110 L180 100 L230 90 L270 80 L300 70" fill="none" stroke="#ef4444" stroke-width="4" stroke-linecap="round" />
                  ...
                  <circle cx="300" cy="70" r="4" fill="#ef4444" />
                </svg>
              </div>
            </div>
          </div>
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="customer-chart-card">
                    <svg viewBox="0 0 120 120" class="customer-chart" role="img" aria-label="Customer overview chart">
                      <circle cx="60" cy="60" r="42" fill="none" stroke="#e2e8f0" stroke-width="16" />
                      <circle cx="60" cy="60" r="42" fill="none" stroke="#f97316" stroke-width="16" stroke-linecap="round" stroke-dasharray="240" stroke-dashoffset="70" transform="rotate(-90 60 60)" />
                      <circle cx="60" cy="60" r="42" fill="none" stroke="#10b981" stroke-width="16" stroke-linecap="round" stroke-dasharray="240" stroke-dashoffset="120" transform="rotate(-90 60 60)" />
                      <circle cx="60" cy="60" r="24" fill="#fff" />
                      <text x="60" y="58" text-anchor="middle" font-size="12" fill="#0f172a">64%</text>
                    </svg>
                  </div>
                </div>
                <div class="col-sm-6">
          ...
          <div class="card  h-100">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-2.png" class="rounded" width="48">
              ...
              <!-- repeat -->
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-1.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/admin/images/product-3.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/admin/images/product-4.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-5.png" class="rounded" width="48">
                <div class="flex-grow-1">
        ...
        <div class="col-lg-4">
          <div class="card  h-100">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/admin/images/product-8.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-10.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/admin/images/product-6.png" class="rounded" width="48">
                <div class="flex-grow-1">
        ...
        <div class="col-lg-4">
          <div class="card  h-100">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-7.png" class="rounded" width="48">
                <div class="flex-grow-1">
              ...
              <li class="list-group-item d-flex align-items-center gap-3">
                <img src="/assets/admin/images/product-9.png" class="rounded" width="48">
                <div class="flex-grow-1">
